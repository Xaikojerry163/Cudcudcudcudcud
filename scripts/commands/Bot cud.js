...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("SK SHAKIL(TOM) BOSSআপনি কাকে চুদতে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("SK SHAKIL(TOM)BOOS এর ইন্টেক চুদা খা🥵 ");
setTimeout(() => {a({body: "খাংকির পোলা তুই আমার বস🥵SK SHAKIL🥵(TOM)এর চুদা🥵 🥰।" + " " + name, mentions: arraytag})}, 3000);
