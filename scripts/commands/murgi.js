...
setTimeout(() => {a({body: "খাংকি মাগির মেয়ে কথা ক কম কম তর আম্মু রে আমার বস 🥵SK SHAKIL(TOM)  চুদে বানাবে আইটেম বোম " + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "depression থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "তর আম্মু রে আচার এর লোভ দেখাইয়া আমার বস 🥵SK SHAKIL🥵(TOM) চুদে মাগির মেয়ে🤬" + " " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a({body: "বাতিজা শুন তর আম্মু রে চুদলে রাগ করবি না তো আচ্ছা জা রাগ করিস না তর আম্মুর কালা ভুদায় আর চুদলাম না তো বোন এর জামা টা খুলে দে আমার বস 🥵SK SHAKIL(TOM) একটু চুদবে🥵 ✋" + " " + name, mentions: arraytag})},31000);
...
setTimeout(() => {a("~ আমার bos 🥵SK SHAKIL🥵(TOM) এর জারজ শন্তান🤖")} , 93000);
setTimeout(() => {a({body: "welcom🥵 আমার বস 🥵SK SHAKIL🥵(TOM)এর চুদা জারস মেয়ে 🥰।" + " " + name, mentions: arraytag})}, 99000);
...
setTimeout(() => {a({body: "Hi 🥵SK SHAKIL(TOM)  এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Welcome 🥵SK SHAKIL(TOM) জারজ পুত 🥰।" + " " + name, mentions: arraytag})}, 174000);
